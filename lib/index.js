...
import { create_cmd_runner } from './cmd-runner.js'
...
export default async function (options) {
  ...
  try {
    ...
    const cmd_runner = create_cmd_runner({
    ...
    const cmd_tasks = await cmd_runner.generate_cmd_tasks()
    ...
    await create_runner({ ...opts, cmd_runner, git_paths, cmd_tasks, files, type }).run()
  } catch (error) {
